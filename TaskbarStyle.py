import win32
import ctypes
from TaskbarCenter import Window
...
def win_button(hidden=False, index=0):
    ...
    win32.SetWindowPos(windows_button.hwnd, taskbar.rect[0] - windows_button.rect[0], int(hidden)*10000, 0, 0, flags=win32.SWP_NOSIZE)